...
VENDOR_HWSERVICE_CONTEXTS_FILE = 'vendor_hwservice_contexts'
VENDOR_HWSERVICE_CONTEXTS_PATH = os.path.join(SELINUX_PATH, VENDOR_HWSERVICE_CONTEXTS_FILE)

decompiler = SepolicyDecompiler(VENDOR_CIL_PATH,
				PLAT_PUB_CIL_PATH,
				VENDOR_PROPERTY_CONTEXTS_PATH,
				VENDOR_FILE_CONTEXTS_PATH,
				VENDOR_HWSERVICE_CONTEXTS_PATH,
				OUTPUT_PATH)
